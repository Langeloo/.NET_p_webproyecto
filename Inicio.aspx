<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="Baberia.Inicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="home" class="parallax">
		<div id="full-width" class="owl-carousel owl-theme home-hero">
			...
			<!-- Contenidos del banner movible -->
			<div class="text-center item slider-02 display-table overlay">
				<div class="display-table-cell">
					<div class="big-tagline text-center">
						<h2><strong>Elegance Barber Shop</strong><br>
						En Colombia</h2>
						<p class="lead">La mejor barbería</p>
						<a href="#" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn">Contactanos</a>
					</div>
				</div>
			</div>
			<!-- Contenidos del banner movible -->
				...
				<div class="row dev-list text-center">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
						<div class="widget our-inner-taem clearfix">
							<div class="t-top"></div>
							<div class="hover-br">
								<img src="/uploads/andres.jpg" alt="" class="img-responsive">
							...
							<div class="team-box">
								<div class="widget-title">
									<h3>Andres Gonzales</h3>
									<small>El fundador de la Barbería</small>
								</div>
								<!-- end title -->
								<p>Soy el Fundador de la Barbería, con más de 5 años en el negocio, y mucha experiencia, lleno de talento, y LISTO PARA DARTE EL MEJOR ESTILO!!!</p>
							</div>
